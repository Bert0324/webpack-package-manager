module.exports = class LineWriter{
    ...
    constructor(options) {
        ...
        this.info = `${LineWriter.colors().reset}Package Update Remind: green means it can be updated safely, red means may have problems with compatibility, white means no new version detect\n`;
    }
